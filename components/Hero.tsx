...
export default function Hero() {
  return (
    <>
      <section>
        <div className="flex px-6 mt-8 lg:mt-0 lg:px-40 lg:flex-row flex-col justify-between lg:gap-20 gap-10 items-center">
          <div className="z-30">
            <div>
              <Image
                src={"/assets/camp.svg"}
                ...
                alt="camp"
              />
              <h1 className="font-semibold md:text-6xl text-5xl lg:text-8xl leading-tight">
            ...
            <div className="flex lg:items-center items-start justify-start lg:flex-row flex-col mt-8 gap-4">
